...
<div class="container">
    <div class="row">
        ...
        <div class="col-lg-9">
            ...
            <!-- Date/Time -->
            <p><span class="glyphicon glyphicon-time"></span> Posted on : {{$tintuc1->created_at}}</p>

            <p>Views : {{$tintuc1->SoLuotXem}}</p>
            <hr>

            <!-- Post Content -->
            <p class="lead">
            	<!-- dùng cái này để in ra thẻ html do người dùng tự thêm vào -->
            	{!! $tintuc1->NoiDung !!}
            </p>
            ...
            <div class="well">
                ...
                <form action="comment/{{$tintuc1->id}}" method="post" role="form">
